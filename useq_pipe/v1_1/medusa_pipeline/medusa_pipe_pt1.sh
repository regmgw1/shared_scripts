...
$PATH2SCRIPTS/perl_scripts/sam2bedgff.pl $PATH2INPUT/${NAME}_filter.sam $NAME $SPECIES $READ_LENGTH $CHROM_LIST 0 1 $PATH2OUTPUT/$NAME.bed 
...
if [[ -s $FILE ]] ; then
wigToBigWig $PATH2OUTPUT/${NAME}_rpm.wig $CHROM_LIST $PATH2OUTPUT/${NAME}_rpm.bw
