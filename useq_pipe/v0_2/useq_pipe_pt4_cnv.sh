...
# $7 = Perform CNV correction on windowed data (0 or 1)
# $8 = Path to the directory containing CNV files.
# $9 = Maximum chromosome number i.e. human = 22, mouse = 19

CURRENT=`pwd`
cd $4
java -Xmx10G -jar $USEQ_HOME/MultipleReplicaScanSeqsCnv -t $1 -c $2 -s $3 -p 0 -w 500 -r /usr/local/bin/R -m $5 -f $6 -v $7 -n $8 -x $9
