...
perl ${10}/peak_explorer_bedtools.pl $WORKING/sample.list ../ $WORKING $WORKING/peakDir.list ${11}

echo "perl ${10}/peaks_in_features_bedtools_wrap.pl $WORKING $WORKING/peakDir.list $7 $8 $6 $9 $GFF_OR_BED ${10} ${11}"
